...
<head>
    ...
    <link rel="stylesheet" href="{{asset('styles/tb/gif19.css')}}">
    ...
    <div class="row">
        ...
        <div class="col-lg">
            <div class="text-center pb-1">
                <img class="lineuptitle img-fluid" src="assets/tb/textgif19.png" alt="title">
            </div>
            <div class="text-center">
                <span class="clickposter">Click image below to watch our aftermovie</span> 
            </div>
            <div class="text-center">
                <a href="https://www.youtube.com/watch?v=llxivSjULgs"><img class="gif19 img-fluid" src="assets/tb/gif19.png" alt="gif 19 poster"></a>
            </div>
        </div>
    </div>
</div>
